...
if TYPE_CHECKING:
    ...
    from ..models.api_response_of_account_links import ApiResponseOfAccountLinks
...
T = TypeVar("T", bound="ApiResponseOfAccount")
...
class ApiResponseOfAccount:
    ...
    Attributes:
        ...
        data (Union[Unset, Account]):
        links (Union[Unset, ApiResponseOfAccountLinks]):
    ...
    data: Union[Unset, "Account"] = UNSET
    links: Union[Unset, "ApiResponseOfAccountLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfAccountLinks.from_dict(_links)
        ...
        api_response_of_account.additional_properties = d
        return api_response_of_account

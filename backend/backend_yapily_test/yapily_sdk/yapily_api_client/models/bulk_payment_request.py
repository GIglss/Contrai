...
T = TypeVar("T", bound="BulkPaymentRequest")
...
class BulkPaymentRequest:
    ...
    Attributes:
        ...
        originator_identification_number (Union[Unset, str]): __Conditional__. The identification number of the
            originator.<ul><li>Mandatory for AIB bulk payments</li><li>Mandatory for HSBC Corporate bulk payments. This will
            be the Connect Profile ID</li></ul>

...
if TYPE_CHECKING:
    from ..models.hosted_account_request import HostedAccountRequest
    from ..models.institution_identifiers import InstitutionIdentifiers
    from ..models.user_settings import UserSettings


T = TypeVar("T", bound="CreateHostedConsentRequest")


@_attrs_define
class CreateHostedConsentRequest:
    """
    Attributes:
        institution_identifiers (InstitutionIdentifiers): Specifies the institution requirements for making the payment.
            ...
            provided.
        redirect_url (str): URL of your server to redirect the user after completion of the consent flow. Example:
        ...
        one_time_token (Union[Unset, bool]): Used to receive a oneTimeToken rather than a consentToken at the
            redirectUrl for additional security. Example: false.
        account_request (Union[Unset, HostedAccountRequest]): __Conditional__. Used to further specify details of the
    ...
    account_request: Union[Unset, "HostedAccountRequest"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        account_request: Union[Unset, HostedAccountRequest]
        if isinstance(_account_request, Unset):
            account_request = UNSET
        else:
            account_request = HostedAccountRequest.from_dict(_account_request)

        create_hosted_consent_request = cls(
        ...
        create_hosted_consent_request.additional_properties = d
        return create_hosted_consent_request

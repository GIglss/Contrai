...
if TYPE_CHECKING:
    from ..models.api_response_of_user_delete_response_links import ApiResponseOfUserDeleteResponseLinks
    ...
    from ..models.user_delete_response import UserDeleteResponse


T = TypeVar("T", bound="ApiResponseOfUserDeleteResponse")
...
class ApiResponseOfUserDeleteResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, UserDeleteResponse]): Deletion of the user. Includes the user profile and all associate
            consents.
        links (Union[Unset, ApiResponseOfUserDeleteResponseLinks]):
    ...
    data: Union[Unset, "UserDeleteResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfUserDeleteResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, UserDeleteResponse]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = UserDeleteResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfUserDeleteResponseLinks.from_dict(_links)
        ...
        api_response_of_user_delete_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_user_delete_response.additional_properties = d
        return api_response_of_user_delete_response

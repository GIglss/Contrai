...
if TYPE_CHECKING:
    ...
    from ..models.account_api_list_response_links import AccountApiListResponseLinks
    from ..models.filtered_client_payload_list_account import FilteredClientPayloadListAccount
...
T = TypeVar("T", bound="AccountApiListResponse")
...
class AccountApiListResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, list['Account']]):
        links (Union[Unset, AccountApiListResponseLinks]):
        forwarded_data (Union[Unset, list['ResponseForwardedData']]):
        raw (Union[Unset, list['RawResponse']]):
        paging (Union[Unset, FilteredClientPayloadListAccount]):
        tracing_id (Union[Unset, str]):
    """

    meta: Union[Unset, "ResponseListMeta"] = UNSET
    data: Union[Unset, list["Account"]] = UNSET
    links: Union[Unset, "AccountApiListResponseLinks"] = UNSET
    forwarded_data: Union[Unset, list["ResponseForwardedData"]] = UNSET
    raw: Union[Unset, list["RawResponse"]] = UNSET
    paging: Union[Unset, "FilteredClientPayloadListAccount"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Account.from_dict(data_item_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = AccountApiListResponseLinks.from_dict(_links)
        ...
        if isinstance(_paging, Unset):
            ...
            paging = FilteredClientPayloadListAccount.from_dict(_paging)

        tracing_id = d.pop("tracingId", UNSET)

        account_api_list_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        account_api_list_response.additional_properties = d
        return account_api_list_response

...
if TYPE_CHECKING:
    ...
    from ..models.filtered_client_payload_list_institution_paging_map import (
        FilteredClientPayloadListInstitutionPagingMap,
    )
    from ..models.institution import Institution


T = TypeVar("T", bound="FilteredClientPayloadListInstitution")
...
class FilteredClientPayloadListInstitution:
    ...
    Attributes:
        ...
        paging_map (Union[Unset, FilteredClientPayloadListInstitutionPagingMap]):
    ...
    paging_map: Union[Unset, "FilteredClientPayloadListInstitutionPagingMap"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_paging_map, Unset):
            ...
            paging_map = FilteredClientPayloadListInstitutionPagingMap.from_dict(_paging_map)

        total_count = d.pop("totalCount", UNSET)

        filtered_client_payload_list_institution = cls(
            api_call=api_call,
            data=data,
        ...
        filtered_client_payload_list_institution.additional_properties = d
        return filtered_client_payload_list_institution

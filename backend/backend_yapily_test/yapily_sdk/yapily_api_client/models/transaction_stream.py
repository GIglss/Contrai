...
T = TypeVar("T", bound="TransactionStream")
...
class TransactionStream:
    ...
    Attributes:
        name (Union[Unset, str]): The name of the Transaction Stream. Example: Amazon Marketplace.
        transactions (Union[Unset, list['EnrichedTransaction']]): A list of transaction details, identified by Yapily
            data services.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        transaction_stream.additional_properties = d

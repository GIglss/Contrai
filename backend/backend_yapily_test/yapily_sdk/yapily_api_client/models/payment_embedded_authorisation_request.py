...
T = TypeVar("T", bound="PaymentEmbeddedAuthorisationRequest")


@_attrs_define
class PaymentEmbeddedAuthorisationRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_embedded_authorisation_request = cls(
        ...
        payment_embedded_authorisation_request.additional_properties = d
        return payment_embedded_authorisation_request

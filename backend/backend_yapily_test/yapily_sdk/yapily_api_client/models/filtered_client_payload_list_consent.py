...
if TYPE_CHECKING:
    ...
    from ..models.filtered_client_payload_list_consent_paging_map import FilteredClientPayloadListConsentPagingMap


T = TypeVar("T", bound="FilteredClientPayloadListConsent")
...
class FilteredClientPayloadListConsent:
    ...
    Attributes:
        ...
        paging_map (Union[Unset, FilteredClientPayloadListConsentPagingMap]):
    ...
    paging_map: Union[Unset, "FilteredClientPayloadListConsentPagingMap"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_paging_map, Unset):
            ...
            paging_map = FilteredClientPayloadListConsentPagingMap.from_dict(_paging_map)

        total_count = d.pop("totalCount", UNSET)

        filtered_client_payload_list_consent = cls(
            api_call=api_call,
            data=data,
        ...
        filtered_client_payload_list_consent.additional_properties = d
        return filtered_client_payload_list_consent

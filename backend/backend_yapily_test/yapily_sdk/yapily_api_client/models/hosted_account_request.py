...
T = TypeVar("T", bound="HostedAccountRequest")


@_attrs_define
class HostedAccountRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hosted_account_request.additional_properties = d
        return hosted_account_request

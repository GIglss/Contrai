...
if TYPE_CHECKING:
    from ..models.api_response_of_payment_responses_links import ApiResponseOfPaymentResponsesLinks
    from ..models.payment_responses import PaymentResponses
...
T = TypeVar("T", bound="ApiResponseOfPaymentResponses")
...
class ApiResponseOfPaymentResponses:
    ...
    Attributes:
        ...
        data (Union[Unset, PaymentResponses]):
        links (Union[Unset, ApiResponseOfPaymentResponsesLinks]):
    ...
    data: Union[Unset, "PaymentResponses"] = UNSET
    links: Union[Unset, "ApiResponseOfPaymentResponsesLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = PaymentResponses.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfPaymentResponsesLinks.from_dict(_links)
        ...
        api_response_of_payment_responses = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_payment_responses.additional_properties = d
        return api_response_of_payment_responses

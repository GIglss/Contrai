...
if TYPE_CHECKING:
    from ..models.api_response_of_sweeping_authorisation_response_links import (
    ...
    from ..models.sweeping_authorisation_response import SweepingAuthorisationResponse


T = TypeVar("T", bound="ApiResponseOfSweepingAuthorisationResponse")


@_attrs_define
class ApiResponseOfSweepingAuthorisationResponse:
    """
    Attributes:
        meta (Union[Unset, ResponseMeta]):
        data (Union[Unset, SweepingAuthorisationResponse]):
        links (Union[Unset, ApiResponseOfSweepingAuthorisationResponseLinks]):
    ...
    data: Union[Unset, "SweepingAuthorisationResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfSweepingAuthorisationResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = SweepingAuthorisationResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfSweepingAuthorisationResponseLinks.from_dict(_links)
        ...
        api_response_of_sweeping_authorisation_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_sweeping_authorisation_response.additional_properties = d
        return api_response_of_sweeping_authorisation_response

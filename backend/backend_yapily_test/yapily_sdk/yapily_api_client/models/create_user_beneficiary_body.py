...
T = TypeVar("T", bound="CreateUserBeneficiaryBody")


@_attrs_define
class CreateUserBeneficiaryBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_user_beneficiary_body = cls(
            name=name,
            account_identifier=account_identifier,
        )

        create_user_beneficiary_body.additional_properties = d
        return create_user_beneficiary_body

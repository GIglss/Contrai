...
T = TypeVar("T", bound="PaymentAuthorisationRequestResponse")
...
class PaymentAuthorisationRequestResponse:
    """
    Attributes:
        id (Union[Unset, UUID]): Unique identifier for the payment authorisation request. <br><br>The `consentID` used
            to [retrieve a consent](/api/reference/#operation/getConsentById).
        ...
        qr_code_url (Union[Unset, str]): The URL for a QR code that may be scanned via a mobile device to make a
            authorisation redirect to the bank (authURL encoded).
        explanation (Union[Unset, str]): Message from the `Institution` received by Yapily, detailing the next action
            the user is required to take. This is used only for Decoupled flows.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_authorisation_request_response = cls(
            id=id,
            user_uuid=user_uuid,
        ...
        payment_authorisation_request_response.additional_properties = d
        return payment_authorisation_request_response

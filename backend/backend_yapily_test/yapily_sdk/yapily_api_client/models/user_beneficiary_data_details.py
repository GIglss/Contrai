...
T = TypeVar("T", bound="UserBeneficiaryDataDetails")


@_attrs_define
class UserBeneficiaryDataDetails:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        user_beneficiary_data_details = cls(
            name=name,
            account_identifier=account_identifier,
            match=match,
        )

        user_beneficiary_data_details.additional_properties = d
        return user_beneficiary_data_details

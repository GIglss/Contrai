...
from ..models.webhook_status_type import WebhookStatusType
...
T = TypeVar("T", bound="WebhookSecretResetResponse201Data")


@_attrs_define
class WebhookSecretResetResponse201Data:
    """
    Attributes:
        ...
        status (Union[Unset, WebhookStatusType]):
        webhook_secret (Union[Unset, str]): HMAC secret needed to validate that the request payload is genuine
    """
    ...
    status: Union[Unset, WebhookStatusType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = WebhookStatusType(_status)

        webhook_secret = d.pop("webhookSecret", UNSET)

        webhook_secret_reset_response_201_data = cls(
            id=id,
        ...
        webhook_secret_reset_response_201_data.additional_properties = d
        return webhook_secret_reset_response_201_data

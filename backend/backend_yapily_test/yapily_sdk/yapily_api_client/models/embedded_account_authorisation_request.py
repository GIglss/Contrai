...
T = TypeVar("T", bound="EmbeddedAccountAuthorisationRequest")
...
class EmbeddedAccountAuthorisationRequest:
    ...
    Attributes:
        ...
        callback (Union[Unset, str]): __Optional__. The server to redirect the user to after the user complete the
            authorisation at the `Institution`. <br><br>See [Using a callback (Optional)](https://docs.yapily.com/) for more
            information. Example: https://display-parameters.com.
        ...
        sca_code (Union[Unset, str]): __Conditional__. Used to update the authorisation with the sca code received by
            the user from the `Institution` using the embedded account authorisation flow.<br><br>This is the penultimate
            step required in the embedded account authorisation flow to authorise the `Consent`. After sending the sca code,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        embedded_account_authorisation_request = cls(
        ...
        embedded_account_authorisation_request.additional_properties = d
        return embedded_account_authorisation_request

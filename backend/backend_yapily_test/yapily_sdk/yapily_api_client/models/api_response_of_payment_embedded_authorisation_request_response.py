...
if TYPE_CHECKING:
    from ..models.api_response_of_payment_embedded_authorisation_request_response_links import (
        ApiResponseOfPaymentEmbeddedAuthorisationRequestResponseLinks,
    )
    from ..models.payment_embedded_authorisation_request_response import PaymentEmbeddedAuthorisationRequestResponse
...
T = TypeVar("T", bound="ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse")
...
class ApiResponseOfPaymentEmbeddedAuthorisationRequestResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, PaymentEmbeddedAuthorisationRequestResponse]):
        links (Union[Unset, ApiResponseOfPaymentEmbeddedAuthorisationRequestResponseLinks]):
    ...
    data: Union[Unset, "PaymentEmbeddedAuthorisationRequestResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfPaymentEmbeddedAuthorisationRequestResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = PaymentEmbeddedAuthorisationRequestResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfPaymentEmbeddedAuthorisationRequestResponseLinks.from_dict(_links)
        ...
        api_response_of_payment_embedded_authorisation_request_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_payment_embedded_authorisation_request_response.additional_properties = d
        return api_response_of_payment_embedded_authorisation_request_response

...
T = TypeVar("T", bound="PaymentResponses")
...
class PaymentResponses:
    """
    Attributes:
        payments (Union[Unset, list['PaymentResponse']]):
    """

    payments: Union[Unset, list["PaymentResponse"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        payment_responses = cls(
            payments=payments,
        )

        payment_responses.additional_properties = d

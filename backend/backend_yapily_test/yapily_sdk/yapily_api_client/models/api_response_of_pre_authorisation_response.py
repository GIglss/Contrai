...
if TYPE_CHECKING:
    from ..models.api_response_of_pre_authorisation_response_links import ApiResponseOfPreAuthorisationResponseLinks
    from ..models.pre_authorisation_response import PreAuthorisationResponse
...
T = TypeVar("T", bound="ApiResponseOfPreAuthorisationResponse")


@_attrs_define
class ApiResponseOfPreAuthorisationResponse:
    """
    Attributes:
        meta (Union[Unset, ResponseMeta]):
        data (Union[Unset, PreAuthorisationResponse]):
        links (Union[Unset, ApiResponseOfPreAuthorisationResponseLinks]):
    ...
    data: Union[Unset, "PreAuthorisationResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfPreAuthorisationResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = PreAuthorisationResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfPreAuthorisationResponseLinks.from_dict(_links)
        ...
        api_response_of_pre_authorisation_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_pre_authorisation_response.additional_properties = d
        return api_response_of_pre_authorisation_response

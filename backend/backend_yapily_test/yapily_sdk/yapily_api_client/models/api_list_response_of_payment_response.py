...
if TYPE_CHECKING:
    from ..models.api_list_response_of_payment_response_links import ApiListResponseOfPaymentResponseLinks
    from ..models.filtered_client_payload_list_payment_response import FilteredClientPayloadListPaymentResponse
...
T = TypeVar("T", bound="ApiListResponseOfPaymentResponse")
...
class ApiListResponseOfPaymentResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, list['PaymentResponse']]):
        links (Union[Unset, ApiListResponseOfPaymentResponseLinks]):
        forwarded_data (Union[Unset, list['ResponseForwardedData']]):
        raw (Union[Unset, list['RawResponse']]):
        paging (Union[Unset, FilteredClientPayloadListPaymentResponse]):
        tracing_id (Union[Unset, str]):
    """

    meta: Union[Unset, "ResponseListMeta"] = UNSET
    data: Union[Unset, list["PaymentResponse"]] = UNSET
    links: Union[Unset, "ApiListResponseOfPaymentResponseLinks"] = UNSET
    forwarded_data: Union[Unset, list["ResponseForwardedData"]] = UNSET
    raw: Union[Unset, list["RawResponse"]] = UNSET
    paging: Union[Unset, "FilteredClientPayloadListPaymentResponse"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = PaymentResponse.from_dict(data_item_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiListResponseOfPaymentResponseLinks.from_dict(_links)
        ...
        if isinstance(_paging, Unset):
            ...
            paging = FilteredClientPayloadListPaymentResponse.from_dict(_paging)

        tracing_id = d.pop("tracingId", UNSET)

        api_list_response_of_payment_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_list_response_of_payment_response.additional_properties = d
        return api_list_response_of_payment_response

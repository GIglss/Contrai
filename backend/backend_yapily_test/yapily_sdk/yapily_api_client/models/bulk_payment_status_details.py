...
if TYPE_CHECKING:
    from ..models.bulk_payment_status_details_iso_status import BulkPaymentStatusDetailsIsoStatus
    from ..models.multi_authorisation import MultiAuthorisation


T = TypeVar("T", bound="BulkPaymentStatusDetails")


@_attrs_define
class BulkPaymentStatusDetails:
    """
    Attributes:
        ...
        iso_status (Union[Unset, BulkPaymentStatusDetailsIsoStatus]): The Institution's status for this Bulk Payment.
    """
    ...
    iso_status: Union[Unset, "BulkPaymentStatusDetailsIsoStatus"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        iso_status: Union[Unset, BulkPaymentStatusDetailsIsoStatus]
        if isinstance(_iso_status, Unset):
            iso_status = UNSET
        else:
            iso_status = BulkPaymentStatusDetailsIsoStatus.from_dict(_iso_status)

        bulk_payment_status_details = cls(
            status=status,
        ...
        bulk_payment_status_details.additional_properties = d
        return bulk_payment_status_details

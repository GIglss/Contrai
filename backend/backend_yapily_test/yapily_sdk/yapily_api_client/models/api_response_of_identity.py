...
if TYPE_CHECKING:
    from ..models.api_response_of_identity_links import ApiResponseOfIdentityLinks
...
T = TypeVar("T", bound="ApiResponseOfIdentity")
...
class ApiResponseOfIdentity:
    ...
    Attributes:
        ...
        data (Union[Unset, Identity]): Identification details of a party associated with an account e.g. (account owner
            or operator).
        links (Union[Unset, ApiResponseOfIdentityLinks]):
    ...
    data: Union[Unset, "Identity"] = UNSET
    links: Union[Unset, "ApiResponseOfIdentityLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, Identity]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = Identity.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfIdentityLinks.from_dict(_links)
        ...
        api_response_of_identity.additional_properties = d
        return api_response_of_identity

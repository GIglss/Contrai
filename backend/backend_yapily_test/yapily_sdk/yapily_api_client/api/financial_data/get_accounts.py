...
from ...models.account_api_list_response import AccountApiListResponse
...
) -> Union[AccountApiListResponse, ApiResponseError]:
    if response.status_code == 200:
        response_200 = AccountApiListResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AccountApiListResponse, ApiResponseError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Accounts
     ...
     Returns all accounts and balances for the end user associated with the presented consent
    token.<br><br>Feature: `ACCOUNTS`
...
def sync(
    *,
    ...
    psu_ip_address: Union[Unset, str] = UNSET,
    sub_application: Union[Unset, UUID] = UNSET,
) -> Optional[Union[AccountApiListResponse, ApiResponseError]]:
    """Get Accounts

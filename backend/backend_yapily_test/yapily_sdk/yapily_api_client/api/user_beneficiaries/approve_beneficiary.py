...
from ...models.user_beneficiary_validation_request import UserBeneficiaryValidationRequest
...
def _get_kwargs(
    ...
    beneficiary_id: UUID,
    *,
    body: UserBeneficiaryValidationRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/users/{user_id}/beneficiaries/{beneficiary_id}/approve",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        body (UserBeneficiaryValidationRequest): Beneficiary request with the details of the VoP
            result.

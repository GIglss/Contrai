...
from ...models.bulk_payment_authorisation_request import BulkPaymentAuthorisationRequest
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/bulk-payment-auth-requests",
    }
...
def sync_detailed(
    *,
    ...
    Institution in order to give their consent for a bulk payment. See [Bulk
    Payments](https://docs.yapily.com/pages/key-concepts/payments/payment-execution/bulk-payments/) for
    more information. <br><br>See [Redirect Payment Flows](https://docs.yapily.com/pages/key-
    concepts/payments/payment-authorisation/redirect-payment-flows/) for more information about this
    flow.<br><br>Feature: `INITIATE_BULK_PAYMENT`

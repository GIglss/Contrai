...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/embedded-payment-auth-requests/{consent_id}",
    }
...
def sync_detailed(
    ...
    *,
    ...
    authorisation to initiate a payment. <br><br> See [Embedded Payment
    Flows](https://docs.yapily.com/guides/payments/payment-authorisation-flows/embedded/) for more
    information about this flow.<br><br>Feature: `INITIATE_EMBEDDED_DOMESTIC_SINGLE_PAYMENT`

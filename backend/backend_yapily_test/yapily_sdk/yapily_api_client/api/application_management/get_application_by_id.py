...
) -> Optional[Union[ApiErrorResponse, ApiResponseOfApplicationResponse]]:
    if response.status_code == 200:
        response_200 = ApiResponseOfApplicationResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiErrorResponse, ApiResponseOfApplicationResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ApiErrorResponse, ApiResponseOfApplicationResponse]
    """

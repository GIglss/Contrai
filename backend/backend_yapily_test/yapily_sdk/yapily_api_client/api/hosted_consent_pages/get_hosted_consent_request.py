...
from ...models.api_response_of_get_hosted_consent_request import ApiResponseOfGetHostedConsentRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/hosted/consent-requests/{consent_request_id}",
    }
...
) -> Union[ApiResponseError, ApiResponseOfGetHostedConsentRequest]:
    if response.status_code == 200:
        response_200 = ApiResponseOfGetHostedConsentRequest.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiResponseError, ApiResponseOfGetHostedConsentRequest]]:
    return Response(
...
def sync(
    ...
    *,
    client: Union[AuthenticatedClient, Client],
    sub_application: Union[Unset, UUID] = UNSET,
) -> Optional[Union[ApiResponseError, ApiResponseOfGetHostedConsentRequest]]:
    """Get Hosted Consent Request

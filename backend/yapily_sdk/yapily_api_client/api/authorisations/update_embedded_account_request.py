...
from ...models.api_response_of_embedded_account_authorisation_response import (
    ApiResponseOfEmbeddedAccountAuthorisationResponse,
)
from ...models.embedded_account_authorisation_request import EmbeddedAccountAuthorisationRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/embedded-account-auth-requests/{consent_id}",
    }
...
) -> Union[ApiResponseError, ApiResponseOfEmbeddedAccountAuthorisationResponse]:
    if response.status_code == 201:
        response_201 = ApiResponseOfEmbeddedAccountAuthorisationResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiResponseError, ApiResponseOfEmbeddedAccountAuthorisationResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    authorisation to access the user's financial data. <br><br>See [Embedded Account
    Flows](https://docs.yapily.com/pages/key-concepts/account-data/account-authorisation/embedded-
    account-flows/) for more information about this flow.<br><br>Feature:
...
def sync(
    ...
    *,
    ...
    psu_ip_address: Union[Unset, str] = UNSET,
    sub_application: Union[Unset, UUID] = UNSET,
) -> Optional[Union[ApiResponseError, ApiResponseOfEmbeddedAccountAuthorisationResponse]]:
    """Update Embedded Account Authorisation

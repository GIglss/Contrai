...
from ...models.post_transactions_categorisation_body import PostTransactionsCategorisationBody
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: PostTransactionsCategorisationBody,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/transactions/categorisation",
    }
...
def sync_detailed(
    *,
    ...
    """Enrichment
     ...
     Trigger enrichment for the provided set of transactions.

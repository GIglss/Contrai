...
from ...models.api_response_of_identity import ApiResponseOfIdentity
...
) -> Union[ApiResponseError, ApiResponseOfIdentity]:
    if response.status_code == 200:
        response_200 = ApiResponseOfIdentity.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiResponseError, ApiResponseOfIdentity]]:
    return Response(
...
def sync(
    *,
    ...
    consent: str,
    sub_application: Union[Unset, UUID] = UNSET,
) -> Optional[Union[ApiResponseError, ApiResponseOfIdentity]]:
    """Get Identity

...
from ...models.api_response_of_account import ApiResponseOfAccount
...
) -> Union[ApiResponseError, ApiResponseOfAccount]:
    if response.status_code == 200:
        response_200 = ApiResponseOfAccount.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApiResponseError, ApiResponseOfAccount]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Account
     ...
     Returns the account and balance information for a user's specified account.<br><br>Feature:
    `ACCOUNT`
...
def sync(
    ...
    *,
    ...
    psu_ip_address: Union[Unset, str] = UNSET,
    sub_application: Union[Unset, UUID] = UNSET,
) -> Optional[Union[ApiResponseError, ApiResponseOfAccount]]:
    """Get Account

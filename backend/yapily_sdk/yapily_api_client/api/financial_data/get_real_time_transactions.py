...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/accounts/{account_id}/real-time/transactions",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get Real Time Account Transactions
     ...
     Used to get the account transactions for an account in real time with cursor
    pagination<br><br>Feature: `ACCOUNT_TRANSACTIONS`

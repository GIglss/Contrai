...
) -> Optional[Union[Any, ApiErrorResponse, ValidationErrorResponse]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ApiErrorResponse, ValidationErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Any, ApiErrorResponse, ValidationErrorResponse]
    """

...
T = TypeVar("T", bound="HostedVRPLimitsRequest")


@_attrs_define
class HostedVRPLimitsRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hosted_vrp_limits_request.additional_properties = d
        return hosted_vrp_limits_request

...
if TYPE_CHECKING:
    from ..models.api_response_of_event_subscription_response_links import ApiResponseOfEventSubscriptionResponseLinks
    ...
    from ..models.response_on_successful_creation_of_event_subscription import (
        ResponseOnSuccessfulCreationOfEventSubscription,
    )


T = TypeVar("T", bound="ApiResponseOfEventSubscriptionResponse")


@_attrs_define
class ApiResponseOfEventSubscriptionResponse:
    """
    Attributes:
        meta (Union[Unset, ResponseMeta]):
        data (Union[Unset, ResponseOnSuccessfulCreationOfEventSubscription]):
        links (Union[Unset, ApiResponseOfEventSubscriptionResponseLinks]):
    ...
    data: Union[Unset, "ResponseOnSuccessfulCreationOfEventSubscription"] = UNSET
    links: Union[Unset, "ApiResponseOfEventSubscriptionResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.api_response_of_event_subscription_response_links import (
        ...
        if isinstance(_data, Unset):
            ...
            data = ResponseOnSuccessfulCreationOfEventSubscription.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfEventSubscriptionResponseLinks.from_dict(_links)
        ...
        api_response_of_event_subscription_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_event_subscription_response.additional_properties = d
        return api_response_of_event_subscription_response

...
if TYPE_CHECKING:
    ...
    from ..models.api_response_of_account_statement_links import ApiResponseOfAccountStatementLinks
...
T = TypeVar("T", bound="ApiResponseOfAccountStatement")
...
class ApiResponseOfAccountStatement:
    ...
    Attributes:
        ...
        data (Union[Unset, AccountStatement]): Statement information belonging to the account.
        links (Union[Unset, ApiResponseOfAccountStatementLinks]):
    ...
    data: Union[Unset, "AccountStatement"] = UNSET
    links: Union[Unset, "ApiResponseOfAccountStatementLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, AccountStatement]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = AccountStatement.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfAccountStatementLinks.from_dict(_links)
        ...
        api_response_of_account_statement = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_account_statement.additional_properties = d
        return api_response_of_account_statement

...
if TYPE_CHECKING:
    ...
    from ..models.filtered_client_payload_list_account_paging_map import FilteredClientPayloadListAccountPagingMap


T = TypeVar("T", bound="FilteredClientPayloadListAccount")
...
class FilteredClientPayloadListAccount:
    ...
    Attributes:
        ...
        paging_map (Union[Unset, FilteredClientPayloadListAccountPagingMap]):
    ...
    paging_map: Union[Unset, "FilteredClientPayloadListAccountPagingMap"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_paging_map, Unset):
            ...
            paging_map = FilteredClientPayloadListAccountPagingMap.from_dict(_paging_map)

        total_count = d.pop("totalCount", UNSET)

        filtered_client_payload_list_account = cls(
            api_call=api_call,
            data=data,
        ...
        filtered_client_payload_list_account.additional_properties = d
        return filtered_client_payload_list_account

...
if TYPE_CHECKING:
    from ..models.api_response_of_submission_response_links import ApiResponseOfSubmissionResponseLinks
...
T = TypeVar("T", bound="ApiResponseOfSubmissionResponse")
...
class ApiResponseOfSubmissionResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, SubmissionResponse]):
        links (Union[Unset, ApiResponseOfSubmissionResponseLinks]):
    ...
    data: Union[Unset, "SubmissionResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfSubmissionResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = SubmissionResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfSubmissionResponseLinks.from_dict(_links)
        ...
        api_response_of_submission_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_submission_response.additional_properties = d
        return api_response_of_submission_response

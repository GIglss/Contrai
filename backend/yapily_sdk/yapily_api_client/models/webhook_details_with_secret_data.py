...
T = TypeVar("T", bound="WebhookDetailsWithSecretData")


@_attrs_define
class WebhookDetailsWithSecretData:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        webhook_details_with_secret_data = cls(
            id=id,
        ...
        webhook_details_with_secret_data.additional_properties = d
        return webhook_details_with_secret_data

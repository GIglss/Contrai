...
if TYPE_CHECKING:
    ...
    from ..models.filtered_client_payload_list_direct_debit_response_paging_map import (
        FilteredClientPayloadListDirectDebitResponsePagingMap,
    )


T = TypeVar("T", bound="FilteredClientPayloadListDirectDebitResponse")
...
class FilteredClientPayloadListDirectDebitResponse:
    ...
    Attributes:
        ...
        paging_map (Union[Unset, FilteredClientPayloadListDirectDebitResponsePagingMap]):
    ...
    paging_map: Union[Unset, "FilteredClientPayloadListDirectDebitResponsePagingMap"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_paging_map, Unset):
            ...
            paging_map = FilteredClientPayloadListDirectDebitResponsePagingMap.from_dict(_paging_map)

        total_count = d.pop("totalCount", UNSET)

        filtered_client_payload_list_direct_debit_response = cls(
            api_call=api_call,
            data=data,
        ...
        filtered_client_payload_list_direct_debit_response.additional_properties = d
        return filtered_client_payload_list_direct_debit_response

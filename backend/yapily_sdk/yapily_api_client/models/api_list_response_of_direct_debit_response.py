...
if TYPE_CHECKING:
    from ..models.api_list_response_of_direct_debit_response_links import ApiListResponseOfDirectDebitResponseLinks
    from ..models.direct_debit_response import DirectDebitResponse
    from ..models.filtered_client_payload_list_direct_debit_response import FilteredClientPayloadListDirectDebitResponse
...
T = TypeVar("T", bound="ApiListResponseOfDirectDebitResponse")
...
class ApiListResponseOfDirectDebitResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, list['DirectDebitResponse']]):
        links (Union[Unset, ApiListResponseOfDirectDebitResponseLinks]):
        forwarded_data (Union[Unset, list['ResponseForwardedData']]):
        raw (Union[Unset, list['RawResponse']]):
        paging (Union[Unset, FilteredClientPayloadListDirectDebitResponse]):
        tracing_id (Union[Unset, str]):
    """

    meta: Union[Unset, "ResponseListMeta"] = UNSET
    data: Union[Unset, list["DirectDebitResponse"]] = UNSET
    links: Union[Unset, "ApiListResponseOfDirectDebitResponseLinks"] = UNSET
    forwarded_data: Union[Unset, list["ResponseForwardedData"]] = UNSET
    raw: Union[Unset, list["RawResponse"]] = UNSET
    paging: Union[Unset, "FilteredClientPayloadListDirectDebitResponse"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.api_list_response_of_direct_debit_response_links import ApiListResponseOfDirectDebitResponseLinks
        from ..models.direct_debit_response import DirectDebitResponse
        from ..models.filtered_client_payload_list_direct_debit_response import (
        ...
        for data_item_data in _data or []:
            data_item = DirectDebitResponse.from_dict(data_item_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiListResponseOfDirectDebitResponseLinks.from_dict(_links)
        ...
        if isinstance(_paging, Unset):
            ...
            paging = FilteredClientPayloadListDirectDebitResponse.from_dict(_paging)

        tracing_id = d.pop("tracingId", UNSET)

        api_list_response_of_direct_debit_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_list_response_of_direct_debit_response.additional_properties = d
        return api_list_response_of_direct_debit_response

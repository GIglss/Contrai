...
if TYPE_CHECKING:
    from ..models.account_authorisation_response import AccountAuthorisationResponse
    from ..models.api_response_of_account_authorisation_response_links import (
...
T = TypeVar("T", bound="ApiResponseOfAccountAuthorisationResponse")
...
class ApiResponseOfAccountAuthorisationResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, AccountAuthorisationResponse]):
        links (Union[Unset, ApiResponseOfAccountAuthorisationResponseLinks]):
    ...
    data: Union[Unset, "AccountAuthorisationResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfAccountAuthorisationResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = AccountAuthorisationResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfAccountAuthorisationResponseLinks.from_dict(_links)
        ...
        api_response_of_account_authorisation_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_account_authorisation_response.additional_properties = d
        return api_response_of_account_authorisation_response

...
if TYPE_CHECKING:
    from ..models.api_response_of_payment_authorisation_request_response_links import (
        ApiResponseOfPaymentAuthorisationRequestResponseLinks,
    )
    from ..models.payment_authorisation_request_response import PaymentAuthorisationRequestResponse
...
T = TypeVar("T", bound="ApiResponseOfPaymentAuthorisationRequestResponse")
...
class ApiResponseOfPaymentAuthorisationRequestResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, PaymentAuthorisationRequestResponse]):
        links (Union[Unset, ApiResponseOfPaymentAuthorisationRequestResponseLinks]):
    ...
    data: Union[Unset, "PaymentAuthorisationRequestResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfPaymentAuthorisationRequestResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = PaymentAuthorisationRequestResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfPaymentAuthorisationRequestResponseLinks.from_dict(_links)
        ...
        api_response_of_payment_authorisation_request_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_payment_authorisation_request_response.additional_properties = d
        return api_response_of_payment_authorisation_request_response

...
T = TypeVar("T", bound="ExchangeRateInformationResponse")
...
class ExchangeRateInformationResponse:
    ...
    Attributes:
        ...
        exchange_rate_expiry_date (Union[Unset, datetime.datetime]):
    """
    ...
    exchange_rate_expiry_date: Union[Unset, datetime.datetime] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        exchange_rate_expiry_date: Union[Unset, str] = UNSET
        if not isinstance(self.exchange_rate_expiry_date, Unset):
            exchange_rate_expiry_date = self.exchange_rate_expiry_date.isoformat()
        ...
        if exchange_rate_expiry_date is not UNSET:
            field_dict["exchangeRateExpiryDate"] = exchange_rate_expiry_date
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _exchange_rate_expiry_date = d.pop("exchangeRateExpiryDate", UNSET)
        exchange_rate_expiry_date: Union[Unset, datetime.datetime]
        if isinstance(_exchange_rate_expiry_date, Unset):
            exchange_rate_expiry_date = UNSET
        else:
            exchange_rate_expiry_date = isoparse(_exchange_rate_expiry_date)

        exchange_rate_information_response = cls(
            unit_currency=unit_currency,
            rate_type=rate_type,
            rate=rate,
            foreign_exchange_contract_reference=foreign_exchange_contract_reference,
            exchange_rate_expiry_date=exchange_rate_expiry_date,
        )

        exchange_rate_information_response.additional_properties = d
        return exchange_rate_information_response

...
if TYPE_CHECKING:
    from ..models.api_response_of_embedded_account_authorisation_response_links import (
        ApiResponseOfEmbeddedAccountAuthorisationResponseLinks,
    )
    from ..models.embedded_account_authorisation_response import EmbeddedAccountAuthorisationResponse
...
T = TypeVar("T", bound="ApiResponseOfEmbeddedAccountAuthorisationResponse")
...
class ApiResponseOfEmbeddedAccountAuthorisationResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, EmbeddedAccountAuthorisationResponse]):
        links (Union[Unset, ApiResponseOfEmbeddedAccountAuthorisationResponseLinks]):
    ...
    data: Union[Unset, "EmbeddedAccountAuthorisationResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfEmbeddedAccountAuthorisationResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = EmbeddedAccountAuthorisationResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfEmbeddedAccountAuthorisationResponseLinks.from_dict(_links)
        ...
        api_response_of_embedded_account_authorisation_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_embedded_account_authorisation_response.additional_properties = d
        return api_response_of_embedded_account_authorisation_response

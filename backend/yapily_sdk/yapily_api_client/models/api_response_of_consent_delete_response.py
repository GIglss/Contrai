...
if TYPE_CHECKING:
    from ..models.api_response_of_consent_delete_response_links import ApiResponseOfConsentDeleteResponseLinks
...
T = TypeVar("T", bound="ApiResponseOfConsentDeleteResponse")
...
class ApiResponseOfConsentDeleteResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, ConsentDeleteResponse]):
        links (Union[Unset, ApiResponseOfConsentDeleteResponseLinks]):
    ...
    data: Union[Unset, "ConsentDeleteResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfConsentDeleteResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = ConsentDeleteResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfConsentDeleteResponseLinks.from_dict(_links)
        ...
        api_response_of_consent_delete_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_consent_delete_response.additional_properties = d
        return api_response_of_consent_delete_response

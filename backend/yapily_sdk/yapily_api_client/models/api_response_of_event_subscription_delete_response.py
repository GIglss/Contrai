...
if TYPE_CHECKING:
    from ..models.api_response_of_event_subscription_delete_response_links import (
    ...
    from ..models.response_upon_successful_unsubscribe_on_subscription import (
        ResponseUponSuccessfulUnsubscribeOnSubscription,
    )


T = TypeVar("T", bound="ApiResponseOfEventSubscriptionDeleteResponse")
...
class ApiResponseOfEventSubscriptionDeleteResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, ResponseUponSuccessfulUnsubscribeOnSubscription]):
        links (Union[Unset, ApiResponseOfEventSubscriptionDeleteResponseLinks]):
    ...
    data: Union[Unset, "ResponseUponSuccessfulUnsubscribeOnSubscription"] = UNSET
    links: Union[Unset, "ApiResponseOfEventSubscriptionDeleteResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = ResponseUponSuccessfulUnsubscribeOnSubscription.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfEventSubscriptionDeleteResponseLinks.from_dict(_links)
        ...
        api_response_of_event_subscription_delete_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_event_subscription_delete_response.additional_properties = d
        return api_response_of_event_subscription_delete_response

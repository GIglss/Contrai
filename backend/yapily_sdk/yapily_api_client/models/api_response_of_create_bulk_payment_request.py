...
if TYPE_CHECKING:
    from ..models.api_response_of_create_bulk_payment_request_links import ApiResponseOfCreateBulkPaymentRequestLinks
    from ..models.bulk_payment_response import BulkPaymentResponse
...
T = TypeVar("T", bound="ApiResponseOfCreateBulkPaymentRequest")


@_attrs_define
class ApiResponseOfCreateBulkPaymentRequest:
    """
    Attributes:
        meta (Union[Unset, ResponseMeta]):
        data (Union[Unset, BulkPaymentResponse]):
        links (Union[Unset, ApiResponseOfCreateBulkPaymentRequestLinks]):
    ...
    data: Union[Unset, "BulkPaymentResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfCreateBulkPaymentRequestLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.api_response_of_create_bulk_payment_request_links import (
        ...
        if isinstance(_data, Unset):
            ...
            data = BulkPaymentResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfCreateBulkPaymentRequestLinks.from_dict(_links)
        ...
        api_response_of_create_bulk_payment_request = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_create_bulk_payment_request.additional_properties = d
        return api_response_of_create_bulk_payment_request

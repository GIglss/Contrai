...
T = TypeVar("T", bound="RegisteredWebhookWithStatus")


@_attrs_define
class RegisteredWebhookWithStatus:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        registered_webhook_with_status = cls(
            id=id,
        ...
        registered_webhook_with_status.additional_properties = d
        return registered_webhook_with_status

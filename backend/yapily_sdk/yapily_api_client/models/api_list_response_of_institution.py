...
if TYPE_CHECKING:
    from ..models.api_list_response_of_institution_links import ApiListResponseOfInstitutionLinks
    from ..models.filtered_client_payload_list_institution import FilteredClientPayloadListInstitution
...
T = TypeVar("T", bound="ApiListResponseOfInstitution")
...
class ApiListResponseOfInstitution:
    ...
    Attributes:
        ...
        data (Union[Unset, list['Institution']]):
        links (Union[Unset, ApiListResponseOfInstitutionLinks]):
        forwarded_data (Union[Unset, list['ResponseForwardedData']]):
        raw (Union[Unset, list['RawResponse']]):
        paging (Union[Unset, FilteredClientPayloadListInstitution]):
        tracing_id (Union[Unset, str]):
    """

    meta: Union[Unset, "ResponseListMeta"] = UNSET
    data: Union[Unset, list["Institution"]] = UNSET
    links: Union[Unset, "ApiListResponseOfInstitutionLinks"] = UNSET
    forwarded_data: Union[Unset, list["ResponseForwardedData"]] = UNSET
    raw: Union[Unset, list["RawResponse"]] = UNSET
    paging: Union[Unset, "FilteredClientPayloadListInstitution"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Institution.from_dict(data_item_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiListResponseOfInstitutionLinks.from_dict(_links)
        ...
        if isinstance(_paging, Unset):
            ...
            paging = FilteredClientPayloadListInstitution.from_dict(_paging)

        tracing_id = d.pop("tracingId", UNSET)

        api_list_response_of_institution = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_list_response_of_institution.additional_properties = d
        return api_list_response_of_institution

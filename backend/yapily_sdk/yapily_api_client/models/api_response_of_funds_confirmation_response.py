...
if TYPE_CHECKING:
    from ..models.api_response_of_funds_confirmation_response_links import ApiResponseOfFundsConfirmationResponseLinks
    from ..models.funds_confirmation_response import FundsConfirmationResponse
...
T = TypeVar("T", bound="ApiResponseOfFundsConfirmationResponse")
...
class ApiResponseOfFundsConfirmationResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, FundsConfirmationResponse]):
        links (Union[Unset, ApiResponseOfFundsConfirmationResponseLinks]):
    ...
    data: Union[Unset, "FundsConfirmationResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfFundsConfirmationResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.api_response_of_funds_confirmation_response_links import (
        ...
        if isinstance(_data, Unset):
            ...
            data = FundsConfirmationResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfFundsConfirmationResponseLinks.from_dict(_links)
        ...
        api_response_of_funds_confirmation_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_funds_confirmation_response.additional_properties = d
        return api_response_of_funds_confirmation_response

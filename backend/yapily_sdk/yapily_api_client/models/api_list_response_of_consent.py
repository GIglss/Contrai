...
if TYPE_CHECKING:
    from ..models.api_list_response_of_consent_links import ApiListResponseOfConsentLinks
    from ..models.consent import Consent
    from ..models.filtered_client_payload_list_consent import FilteredClientPayloadListConsent
...
T = TypeVar("T", bound="ApiListResponseOfConsent")
...
class ApiListResponseOfConsent:
    ...
    Attributes:
        ...
        data (Union[Unset, list['Consent']]):
        links (Union[Unset, ApiListResponseOfConsentLinks]):
        forwarded_data (Union[Unset, list['ResponseForwardedData']]):
        raw (Union[Unset, list['RawResponse']]):
        paging (Union[Unset, FilteredClientPayloadListConsent]):
        tracing_id (Union[Unset, str]):
    """

    meta: Union[Unset, "ResponseListMeta"] = UNSET
    data: Union[Unset, list["Consent"]] = UNSET
    links: Union[Unset, "ApiListResponseOfConsentLinks"] = UNSET
    forwarded_data: Union[Unset, list["ResponseForwardedData"]] = UNSET
    raw: Union[Unset, list["RawResponse"]] = UNSET
    paging: Union[Unset, "FilteredClientPayloadListConsent"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiListResponseOfConsentLinks.from_dict(_links)
        ...
        if isinstance(_paging, Unset):
            ...
            paging = FilteredClientPayloadListConsent.from_dict(_paging)

        tracing_id = d.pop("tracingId", UNSET)

        api_list_response_of_consent = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_list_response_of_consent.additional_properties = d
        return api_list_response_of_consent

...
if TYPE_CHECKING:
    from ..models.api_response_of_payment_response_links import ApiResponseOfPaymentResponseLinks
...
T = TypeVar("T", bound="ApiResponseOfPaymentResponse")
...
class ApiResponseOfPaymentResponse:
    ...
    Attributes:
        ...
        data (Union[Unset, PaymentResponse]):
        links (Union[Unset, ApiResponseOfPaymentResponseLinks]):
    ...
    data: Union[Unset, "PaymentResponse"] = UNSET
    links: Union[Unset, "ApiResponseOfPaymentResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = PaymentResponse.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfPaymentResponseLinks.from_dict(_links)
        ...
        api_response_of_payment_response = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_response_of_payment_response.additional_properties = d
        return api_response_of_payment_response

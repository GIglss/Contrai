...
if TYPE_CHECKING:
    ...
    from ..models.filtered_client_payload_list_payment_response_paging_map import (
        FilteredClientPayloadListPaymentResponsePagingMap,
    )
    from ..models.payment_response import PaymentResponse


T = TypeVar("T", bound="FilteredClientPayloadListPaymentResponse")
...
class FilteredClientPayloadListPaymentResponse:
    ...
    Attributes:
        ...
        paging_map (Union[Unset, FilteredClientPayloadListPaymentResponsePagingMap]):
    ...
    paging_map: Union[Unset, "FilteredClientPayloadListPaymentResponsePagingMap"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_paging_map, Unset):
            ...
            paging_map = FilteredClientPayloadListPaymentResponsePagingMap.from_dict(_paging_map)

        total_count = d.pop("totalCount", UNSET)

        filtered_client_payload_list_payment_response = cls(
            api_call=api_call,
            data=data,
        ...
        filtered_client_payload_list_payment_response.additional_properties = d
        return filtered_client_payload_list_payment_response

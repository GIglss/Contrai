...
T = TypeVar("T", bound="PreAuthorisationResponse")
...
class PreAuthorisationResponse:
    """
    Attributes:
        id (Union[Unset, UUID]): Unique identifier for the pre-authorisation request.
        ...
        qr_code_url (Union[Unset, str]): The URL link for the QR code that may be scanned via a mobile device to make a
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pre_authorisation_response = cls(
            id=id,
            user_uuid=user_uuid,
        ...
        pre_authorisation_response.additional_properties = d
        return pre_authorisation_response

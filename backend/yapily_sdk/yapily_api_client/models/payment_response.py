...
class PaymentResponse:
    """
    Attributes:
        id (Union[Unset, str]): Unique identifier of the payment.
        institution_consent_id (Union[Unset, str]): Identification of the consent at the Institution.
        payment_idempotency_id (Union[Unset, str]): __Mandatory__. A unique identifier that you must provide to identify
            the payment. This can be any alpha-numeric string but is limited to a maximum of 35 characters.
        ...
        reference (Union[Unset, str]): __Optional__. The payment reference or description. Limited to a maximum of 18
            characters long.
        amount (Union[Unset, float]): Monetary amount.
        currency (Union[Unset, str]): Currency the payment amount is denoted in. Specified as a 3-letter ISO 4217 code.

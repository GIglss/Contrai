...
if TYPE_CHECKING:
    from ..models.api_response_of_consent_links import ApiResponseOfConsentLinks
...
T = TypeVar("T", bound="ApiResponseOfConsent")
...
class ApiResponseOfConsent:
    ...
    Attributes:
        ...
        data (Union[Unset, Consent]): Consent detailing the requested authorisation from a user to a specific
            `Institution`.
        links (Union[Unset, ApiResponseOfConsentLinks]):
    ...
    data: Union[Unset, "Consent"] = UNSET
    links: Union[Unset, "ApiResponseOfConsentLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        data: Union[Unset, Consent]
        if isinstance(_data, Unset):
            data = UNSET
        else:
            data = Consent.from_dict(_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiResponseOfConsentLinks.from_dict(_links)
        ...
        api_response_of_consent.additional_properties = d
        return api_response_of_consent

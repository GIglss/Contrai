...
T = TypeVar("T", bound="EmbeddedAccountAuthorisationResponse")
...
class EmbeddedAccountAuthorisationResponse:
    """
    Attributes:
        id (Union[Unset, UUID]): Unique identifier for the embedded account authorisation request.
        ...
        created_at (Union[Unset, datetime.datetime]): Date and time the embedded authorisation was created by the
            application user.
        ...
        expires_at (Union[Unset, datetime.datetime]): Date and time the embedded authorisation expires. Re-authorisation
        ...
        state (Union[Unset, str]): Correlation ID used when handshaking with a new institution via OAuth2 registration.
        ...
        sca_methods (Union[Unset, list['ScaMethod']]): List of `SCA methods` that the `Institution` supports and are
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        embedded_account_authorisation_response = cls(
            id=id,
            user_uuid=user_uuid,
        ...
        embedded_account_authorisation_response.additional_properties = d
        return embedded_account_authorisation_response

...
if TYPE_CHECKING:
    from ..models.api_list_response_of_beneficiary_links import ApiListResponseOfBeneficiaryLinks
...
T = TypeVar("T", bound="ApiListResponseOfBeneficiary")
...
class ApiListResponseOfBeneficiary:
    ...
    Attributes:
        ...
        data (Union[Unset, list['Beneficiary']]):
        links (Union[Unset, ApiListResponseOfBeneficiaryLinks]):
    ...
    data: Union[Unset, list["Beneficiary"]] = UNSET
    links: Union[Unset, "ApiListResponseOfBeneficiaryLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Beneficiary.from_dict(data_item_data)
        ...
        if isinstance(_links, Unset):
            ...
            links = ApiListResponseOfBeneficiaryLinks.from_dict(_links)
        ...
        api_list_response_of_beneficiary = cls(
            meta=meta,
            data=data,
            links=links,
        ...
        api_list_response_of_beneficiary.additional_properties = d
        return api_list_response_of_beneficiary
